...
import Transfer_icon from "@/public/assets/images/transfer icon.svg";
...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-[1024px]">
        ...
        <nav>
          <ul className="flex flex-col items-center gap-4 ">
            ...
            <Link
              ...
              onClick={() => setActiveNavItem("fundwallet")}
              className={`flex items-center gap-2 py-2 px-8 rounded-md cursor-pointer ${
                activeNavItem === "fundwallet"
                  ? "bg-blue-500 text-white"
                  : "hover:bg-blue-200"
              }`}
            >
            ...
            >
              <li className="flex items-center gap-2 p-2">
                <Image src={Transfer_icon} alt="Transfer_icon" />
                <p>Transfer</p>
              </li>
            </Link>
          </ul>
      ...
      <div className="m-10">
        <Link href="/dashboardpage/logout" className="flex justify-center items-center gap-2">
